...
El ciclo Cognitivo es el sistema lento, costoso y poderoso. Su función no es sobrevivir -el Reptil ya se encarga de eso-. Su función es prosperar: mantener el sistema en condiciones óptimas, aprender del pasado, predecir el futuro y generar un registro interno de la vida del organismo.
...
* Exterocepción: Las mediciones capturadas por los sensores físicos bien sea internos o externos del entorno (temperatura, fotoperiodo y humedad real y el exterior[en el caso de un galpón]). Es impotante señalar que en una granja de codornices el galpón seria el entorno y no el organismo, el organismo son los sensores y actuadores, en cambio en un robot autónomo serían las cámaras(vision), micrófonos(oído), etc.

* Propiocepción: El estado propio del hardware del organismo(qué actuadores estan conectados, que sensores estan funcionando, cuanta energía esta gastando la máquina, temperatura interna del hardware[fiebre]). Es la conciencia del propio cuerpo del organismo. Sin ella el sistema podría intentar encender un actuador que ya está encendido, o ignorar un consumo eléctrico que anuncia una falla inminente.
...
> La activación nunca supera el 1.0(El sistema no puede estar "más que completamente activado"). El peso de atención del ADN controla que tán rápido sube la activación ante un error dado. Esto es muy ventajos para configurar la cognición del organismo.
...
En cada ciclo, el estado emocional del organismo queda descrito cpor un único punto de coordenadas(valencia, activación). Ese punto vive en uno de los cuatro cuadrantes, cada uno con un comportamiento esperado distinto.
